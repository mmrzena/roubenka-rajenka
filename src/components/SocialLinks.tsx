...
const ICONS: Record<string, React.ReactNode> = {
  Instagram: (
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M7.5 2h9A5.5 5.5 0 0 1 22 7.5v9A5.5 5.5 0 0 1 16.5 22h-9A5.5 5.5 0 0 1 2 16.5v-9A5.5 5.5 0 0 1 7.5 2Zm0 2A3.5 3.5 0 0 0 4 7.5v9A3.5 3.5 0 0 0 7.5 20h9a3.5 3.5 0 0 0 3.5-3.5v-9A3.5 3.5 0 0 0 16.5 4h-9Zm4.5 3a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm5.5-2.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5Z"
    />
  ),
  Facebook: (
    <path
      transform="translate(0 -2)"
      d="M9.1 23.7v-8H6.6V12h2.5v-1.6c0-4.1 1.9-6 5.9-6 .4 0 .9 0 1.4.1.5.1.9.1 1.1.2v3.3a8.6 8.6 0 0 0-.6 0h-.8c-.7 0-1.2.1-1.7.3a1.7 1.7 0 0 0-.7.6c-.2.4-.3 1-.3 1.8V12h3.9l-.4 2.1-.3 1.6h-3.2v8H9.1Z"
    />
  ),
  TikTok: (
    <path
      ...
      {SOCIAL_LINKS.map(({ name, href }) => (
        <li key={name}>
          <a
            ...
            aria-label={name}
            title={name}
            className="block transition-[transform,color] hover:-translate-y-0.5"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
